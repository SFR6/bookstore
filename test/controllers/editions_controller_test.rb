...
class EditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edition" do
    assert_difference("Edition.count") do
      post editions_url, params: { edition: { book_id: @edition.book_id, edition_name: @edition.edition_name, format: @edition.format, language: @edition.language, publication_date: @edition.publication_date } }
    end
  ...
  test "should update edition" do
    patch edition_url(@edition), params: { edition: { book_id: @edition.book_id, edition_name: @edition.edition_name, format: @edition.format, language: @edition.language, publication_date: @edition.publication_date } }
