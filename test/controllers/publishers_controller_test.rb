...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference("Publisher.count") do
      post publishers_url, params: { publisher: { address: @publisher.address, city: @publisher.city, country: @publisher.country, county: @publisher.county, name: @publisher.name, zipcode: @publisher.zipcode } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { address: @publisher.address, city: @publisher.city, country: @publisher.country, county: @publisher.county, name: @publisher.name, zipcode: @publisher.zipcode } }
